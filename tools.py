...
if len(sys.argv) == 1:
    ...
    if sys.platform.startswith("win"):
        os.system('cmd /c "pip install Jinja2"')
        ...
        commands = ["pip install Jinja2","arduino-cli config init","arduino-cli core update-index --additional-urls https://dl.espressif.com/dl/package_esp32_index.json","arduino-cli board listall esp32","arduino-cli lib install \"M5StickC\"", "arduino-cli lib install \"SparkFun High Precision Temperature Sensor TMP117 Qwiic\"","arduino-cli lib install \"MAX30100lib\""]
