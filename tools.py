...
if len(sys.argv) == 1:
    ...
    if sys.platform.startswith("win"):
        ...
        os.system('cmd /c "arduino-cli config init"')
        os.system('cmd /c "arduino-cli core install arduino:avr && arduino-cli core update-index --additional-urls https://dl.espressif.com/dl/package_esp32_index.json"')
        ...
        commands = ["arduino-cli config init", "arduino-cli core install arduino:avr",
