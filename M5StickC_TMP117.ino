...
const char * softAP_ssid = "Captive Portal SSID";

const char * softAP_password = "Captive Portal Pass";

const char * myHostname = "Captive Portal Hostname";
...
//Server information to get Time and Date
...
void sendData(float tempC, char timedata[]){ 	
